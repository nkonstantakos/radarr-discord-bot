...
class AddMovieFunction(object):
    ...
    def add_movie(self, imdb_id, movie_name, creator_id, creator_name, private):
        ...
        new_movie: Movie = Movie(None, imdb_id, movie_name, user_record, approved, False, False, private)
    ...
    def check_movie_exists(self, imdb_id: str):
        ...
        if existing_movie is not None:
            raise MovieExistsException(imdb_id)
